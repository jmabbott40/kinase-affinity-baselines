...
Usage (CLI):
    python -m kinase_affinity.features
    python -m kinase_affinity.features --force  # Recompute even if cached
    python -m kinase_affinity.features --config configs/dataset_v1.yaml
"""
...
def compute_and_cache_features(
    ...
    if not curated_path.exists():
        raise FileNotFoundError(
            ...
            "Run the curation pipeline first: python -m kinase_affinity.data.curate"
        )
