...
from kinase_affinity.features import load_morgan_fingerprints, load_rdkit_descriptors
...
def get_model_class(model_name: str):
    ...
    # Split "kinase_affinity.models.rf_model.RandomForestModel"
    # into module="kinase_affinity.models.rf_model", class="RandomForestModel"
