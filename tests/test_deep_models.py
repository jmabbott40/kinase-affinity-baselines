...
class TestMolecularGraphConversion:
    ...
    def test_feature_dimensions(self):
        from kinase_affinity.features.molecular_graphs import (
...
class TestESMFPMLPModel:
    def test_fit_predict(self):
        from kinase_affinity.models.esm_fp_mlp_model import ESMFPMLPModel
...
class TestGNNModel:
    ...
    def test_fit_predict(self, sample_graphs):
        ...
        from kinase_affinity.models.gnn_model import GNNModel
...
class TestFusionModel:
    ...
    def test_fit_predict(self, sample_fusion_data):
        ...
        from kinase_affinity.models.fusion_model import FusionModel
